  ...
  */
  ...
  function flattenMetrics(metrics, groupName, keyName, valueName) {
    ...
    for (var i = 0; i < metrics.length; ++i) {
      ...
      var _labels = sample.labels || {};

      var otherLabels = excludeKey(_labels, keyName);
      var currentKey = JSON.stringify(otherLabels);
      ...
      if (_labels[keyName] !== undefined && sample[valueName] !== undefined) {
        flattened[groupName][_labels[keyName]] = sample[valueName];
      }
